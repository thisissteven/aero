        ...
        {data.ports.map((port) => (
          <li key={port}>
            <button
              ...
              className='border-separator bg-default hover:bg-field-hover text-foreground group focus-visible:ring-accent flex w-full items-center justify-between rounded-lg border px-3.5 py-2.5 text-sm transition-all duration-150 focus-visible:ring-2 focus-visible:outline-none'
            >
