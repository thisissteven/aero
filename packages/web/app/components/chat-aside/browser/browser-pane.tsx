...
export function BrowserPane({
  ...
  return (
    ...
    >
      ...
      <div className='border-separator dark:border-separator/60 flex items-center gap-1 border-b px-2 py-1'>
        ...
        <form className='min-w-0 flex-1'>
          <input
            ...
            className='border-separator dark:border-separator/60 bg-default h-7 w-full rounded-md border px-2 text-sm outline-none'
          />
        </form>
        ...
        {iframeSrc ? (
          <div className='absolute inset-0'>
            ...
            {tab.isInspecting && pendingSelection && editorPosition && (
              <div
                className='border-separator dark:border-separator/70 bg-surface pointer-events-auto absolute flex w-80 items-center gap-1 rounded-full border p-1.5 shadow-xl'
                style={{
            ...
            {!bridgeReady && tab.isInspecting && (
              <div className='border-separator dark:border-separator/60 bg-default/95 text-muted pointer-events-auto absolute bottom-3 left-1/2 -translate-x-1/2 rounded-md border px-3 py-1.5 text-xs shadow-lg'>
