...
function SearchResults({
  ...
  return (
    <div className='w-full min-w-0'>
      ...
      {results.length > 0 ? (
        <div className='divide-separator border-separator bg-surface divide-y overflow-hidden rounded-xl border'>
            ...
            return (
              ...
              >
                <div className='flex min-w-0 gap-3'>
                  <div className='border-separator bg-surface-secondary mt-0.5 flex size-7 shrink-0 items-center justify-center overflow-hidden rounded-lg border'>
                    <img
