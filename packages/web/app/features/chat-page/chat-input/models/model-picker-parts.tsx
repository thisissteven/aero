...
export function ModelSearchInput({
  ...
  return (
    <Command.InputGroup className='border-separator dark:border-separator/50 border-b'>
...
export function AddProviderRow({ onClick }: { onClick?: () => void }) {
  return (
    <div className='border-separator dark:border-separator/50 border-b p-1'>
      <IconButton
        isIconOnly={false}
...
export function ModelPickerFooter() {
  return (
    <div className='text-muted border-separator dark:border-separator/50 flex items-center justify-between border-t px-3 py-1.5'>
...
export function ModelInfoPanelCard({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-overlay/60 text-overlay-foreground border-separator dark:border-separator:40 absolute w-64 space-y-2 rounded-xl border p-3 text-xs backdrop-blur-sm transition-all duration-75',
    ...
    >
      ...
      <div className='text-muted border-separator dark:border-separator/50 flex items-center justify-between border-t pt-1'>
