const AERO_NODE_ENV = 'AERO_NODE_ENV';
const ELECTRON_RUN_AS_NODE = 'ELECTRON_RUN_AS_NODE';

const RUNTIME_CONTROL_ENV_KEYS = [
  AERO_NODE_ENV,
  'AERO_DESKTOP_MANAGED',
  'AERO_SUPERVISED',
  ELECTRON_RUN_AS_NODE,
  'ELECTRON_NO_ATTACH_CONSOLE',
] as const;

export type AeroNodeEnv = 'development' | 'production' | 'test';
...
export function createAeroInternalEnv(
...
export function resolveAeroNodeEnv(
  env: NodeJS.ProcessEnv,
): AeroNodeEnv | undefined {
  const value = env[AERO_NODE_ENV];
